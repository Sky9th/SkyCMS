...
//                }
        ...
        callback: function (editor, $w, url, state, _url) {
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='" + url + "' alt='"+_url+"' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try{
                var json = eval('('+r+')');
                Base.callback(me.editor, me.dialog, json.url, json.state, json._url);
            }catch (e){
